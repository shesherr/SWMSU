ai_navigator:
  ...
  image_path: a7d973ac_ai-navigator.f364e.svg
  install:
    fallback_url: https://anaconda.cloud/api/navigator/v1/applications/open/ai_navigator
    func: ::install_launch
    installer_url: https://autoupdate.ai.anaconda.com/latest-AI-Navigator Setup.exe?utm=anaconda-navigator
  is_available: true
  rank: 4
anaconda-fusion:
...
anaconda_notebooks:
  ...
  image_path: 5b8954fd_anaconda.2f252.png
  is_available: true
  rank: 2
...
glueviz:
  ...
  image_path: 3b06c96f_glueviz.01fec.png
ibm_watson:
  app_type: web_app
...
oracle_oci:
  ...
  image_path: ab1a8068_oracle.18dd0.png
  is_available: true
...
orange-app:
  ...
  image_path: bc2b6ba3_orange.fdf79.png
orange3:
  description: Component based data mining framework. Data visualization and data
    analysis for novice and expert. Interactive workflows with a large toolbox.
...
pycharm_ce:
  ...
  extra_arguments: null
  image_path: 8d0bca3e_pycharm-ce.23cd4.png
...
qt3dstudio:
  ...
  image_path: 0ef96a58_qtcreator.6fe73.png
qtconsole:
...
rodeo:
  ...
  image_path: 8a9bc63a_rodeo.ed5fd.png
rstudio:
  ...
  image_path: 88067319_rstudio.761ec.png
spyder:
  ...
  display_name: Spyder
  image_path: 79da0a0a_spyder.412ae.png
spyder-app:
  image_path: 79da0a0a_spyder.412ae.png
  is_available: false
veusz:
  ...
  image_path: 71f5922c_veusz.46aec.png
vscode:
  app_type: installable
